...
pub const RENDEZVOUS_SERVERS: &[&str] = &["jh.668666.xyz"];
pub const RS_PUB_KEY: &str = "RjiQbZcrpLSnHzF7QT1+Bfepf6NiCk+ibyIGGQaIodk=";

pub const RENDEZVOUS_PORT: i32 = 10352;
pub const RELAY_PORT: i32 = 10367;
pub const WS_RENDEZVOUS_PORT: i32 = 10356;
pub const WS_RELAY_PORT: i32 = 10343;
